...
simulation_figure <- scatter_plot_full_w_labs + scatter_plot_grey + scatter_plot_biased +
    ...
    plot_layout(ncol = 3, byrow = TRUE, heights = c(2.5, NA))

ggsave("figure3_simulation_alt.pdf", simulation_figure, device = cairo_pdf, 
    width = 18, height = 18, units = "cm", scale = 1.15)
ggsave("figure3_simulation_alt.svg", simulation_figure,
    width = 18, height = 18, units = "cm", scale = 1.15)
ggsave("figure3_simulation_alt.png", simulation_figure, device = ragg::agg_png, bg = "white", 
    width = 18, height = 18, units = "cm", scale = 1.15)
